...
public class LabirintoBuilderTest {
	...
	public void testPiuDiQuattroAdiacenti() {
		...
		assertEquals(maze.getStanzaIniziale().getMapStanzeAdiacenti().get(Direction.NORD).getNome(),mappa.get("nord").getNome());
		assertEquals(maze.getStanzaIniziale().getMapStanzeAdiacenti().get(Direction.SUD).getNome(),mappa.get("sud").getNome());
		assertEquals(maze.getStanzaIniziale().getMapStanzeAdiacenti().get(Direction.EST).getNome(),mappa.get("est").getNome());
		assertEquals(maze.getStanzaIniziale().getMapStanzeAdiacenti().get(Direction.OVEST).getNome(),mappa.get("ovest").getNome());
	}
