...
public class LabirintoBuilderTest {
	...
	public void testPiuDiQuattroAdiacenti() {
		...
		assertEquals(maze.getStanzaIniziale().getMapStanzeAdiacenti().get("nord").getNome(),mappa.get("nord").getNome());
		assertEquals(maze.getStanzaIniziale().getMapStanzeAdiacenti().get("sud").getNome(),mappa.get("sud").getNome());
		assertEquals(maze.getStanzaIniziale().getMapStanzeAdiacenti().get("est").getNome(),mappa.get("est").getNome());
		assertEquals(maze.getStanzaIniziale().getMapStanzeAdiacenti().get("ovest").getNome(),mappa.get("ovest").getNome());
	}
	...
	public void testAggiuntaAttrezziAStanze_AppenaAggiunte() {
		...
		labirintoBuilder
				...
				.addAttrezzo(nomeAttrezzo, peso)
				.getLabirinto();
		assertTrue(this.labirintoBuilder.getStanza(nomeStanza).getAttrezzi().contains(new Attrezzo (nomeAttrezzo,peso)));
		assertEquals(new Attrezzo(nomeAttrezzo,peso),this.labirintoBuilder.getStanza(nomeStanza).getAttrezzo(nomeAttrezzo));
	}
	...
	public void testAggiuntaAttrezzoAStanze_AppenaAggiunteMultiple() {
		...
		this.labirintoBuilder
				...
				.getLabirinto();
		Attrezzo attrezzo = new Attrezzo(nomeAttrezzo,peso);
		List<Attrezzo> attrezzi = labirintoBuilder.getStanza(nomeStanza).getAttrezzi();
	...
	public void testAggiuntaAttrezzoAStanze_MoltepliciAttrezziStessaStanza() {
		...
		System.out.println(labirintoBuilder.getStanza(nomeStanza1).getAttrezzi());
		System.out.println(labirintoBuilder.getStanza(nomeStanza1).getAttrezzo(nomeAttrezzo2));
		labirintoBuilder.getListaStanze();
		assertEquals(new Attrezzo(nomeAttrezzo2,peso2),labirintoBuilder.getStanza(nomeStanza1).getAttrezzo(nomeAttrezzo2));
		assertEquals(new Attrezzo(nomeAttrezzo1,peso1),labirintoBuilder.getStanza(nomeStanza1).getAttrezzo(nomeAttrezzo1));
	}
	...
	public void testAggiuntaAttrezzoAStanze_AttrezzoAggiuntoAllaSecondaStanza() {
		...
		assertEquals(new Attrezzo(nomeAttrezzo1,peso1),labirintoBuilder.getStanza(nomeStanza2).getAttrezzo(nomeAttrezzo1));
		assertEquals(new Attrezzo(nomeAttrezzo2,peso2),labirintoBuilder.getStanza(nomeStanza2).getAttrezzo(nomeAttrezzo2));
	}
	...
	public void testLabirintoConStanzaMagica_AggiuntaElementoOltreSogliaMagica() {
		...
		assertEquals(new Attrezzo(nomeAttrezzo2Inv,peso2_x2).getNome(), this.labirintoBuilder.getStanza(nomeStanzaMagica).getAttrezzo(nomeAttrezzo2Inv).getNome());
		assertEquals(new Attrezzo(nomeAttrezzo1,peso1).getNome(), this.labirintoBuilder.getStanza(nomeStanzaMagica).getAttrezzo(nomeAttrezzo1).getNome());
	}
	...
	public void testLabirintoConStanzaBloccata_ConPassepartout() {
		...
		assertEquals(nomeStanzaVincente,labirintoBuilder.getStanza("stanza bloccata").getStanzaAdiacente("nord").getNome());	
	}
	...
	public void testLabirintoConStanzaBloccata_SenzaPassepartout() {
		...
		assertEquals(labirintoBuilder.getStanza("stanza bloccata"),labirintoBuilder.getStanza("stanza bloccata").getStanzaAdiacente("nord"));
	}
